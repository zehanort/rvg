...
class GenericRandom:
    ...
    >>> simple_struct_gen = GenericRandom(simple_struct)
    ...
    ... }
    >>> nested_struct_gen = GenericRandom(nested_struct)
    ...
    ... }
    >>> struct_array_member_gen = GenericRandom(struct_array_member)
